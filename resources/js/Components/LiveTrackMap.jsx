...
// Class Tailwind sengaja di-inline di html divIcon supaya ikut ter-scan saat build.
...
/**
 * Peta pantau live: titik asal, tujuan, posisi pengguna, rute & ETA.
 *
 * Dipakai bersama oleh "pantau perjalanan" pergi bareng dan "pantau pengambilan"
 * jastip - keduanya hanya berbeda label, jadi seluruh label datang dari props.
 */
export default function LiveTrackMap({
    ...
    useEffect(() => {
        ...
        if (
            ...
            // Hitung ulang rute cuma kalau bergeser > ~40 m, biar OSRM tak dibanjiri.
                    ...
                    <div className="mt-4 space-y-3 border-t border-neutral-100 pt-4">
                        <div className="flex items-start gap-3 text-sm">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-neutral-700">{originText}</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3 text-sm">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-neutral-700">{destinationText}</p>
                            </div>
                        </div>
                    </div>
