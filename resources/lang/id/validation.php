...
return [
    ...
    | validator. Beberapa aturan memiliki beberapa versi (array/file/numeric/
    | string) sesuai tipe atribut.
    |
    */

    'accepted' => ':attribute wajib diterima.',
    'accepted_if' => ':attribute wajib diterima ketika :other adalah :value.',
    ...
    'declined_if' => ':attribute wajib ditolak ketika :other adalah :value.',
    ...
    */
    ...
    'custom' => [
        'username' => [
            'regex' => 'Username hanya boleh berisi karakter alfanumerik, garis bawah (_), dan titik (.).',
        ],
        'password' => [
            'strong' => 'Kata sandi harus minimal 15 karakter, ATAU minimal 8 karakter yang mengandung angka dan huruf kecil.',
        ],
    ],
